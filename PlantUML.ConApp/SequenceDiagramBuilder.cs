namespace PlantUML.ConApp
{
    ...
    public partial class SequenceDiagramBuilder(string sourcePath, string targetPath, string diagramFolder, bool force) : UMLDiagramBuilder(sourcePath, targetPath, diagramFolder, false, force)
    {
